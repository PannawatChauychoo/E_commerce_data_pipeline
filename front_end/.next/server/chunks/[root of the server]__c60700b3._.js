...
async function GET(req) {
    ...
    const { rows } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pg"].query(`
    SELECT transaction_id, (unit_price * quanity) as order_value, date_purchased, category
    FROM walmart.transactions
    WHERE date_purchased >= COALESCE($1::timestamp, NOW() - INTERVAL '1 week')
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c60700b3._.js.map